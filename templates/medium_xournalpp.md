...
- Die Aufgabe liegt als `.tex` → PDF, in **Firefox** geöffnet. Gerechnet wird in
  einem **eigenen** `.xopp`-Rechenblatt (`xournalpp <datei> &`) — das letzte
  fortsetzen oder, wenn keins existiert oder das letzte voll ist, ein neues
  leeres anlegen. Zwei Fenster nebeneinander.
